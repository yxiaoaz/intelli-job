...
class ShixisengInternSpider(CrawlSpider):
    ...
    start_urls = ["https://www.shixiseng.com/interns?type=intern&sortType=zj"+f'&page={page}' for page in range(1,201)]
    ...
    def parse(self, response: TextResponse):
        ...
        if time_span:
            ...
            update_time = datetime.strptime(re.sub(r'\s+', ' ', update_time.strip()), "%Y-%m-%d %H:%M:%S")
